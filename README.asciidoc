== Elasticsearch Grails plugin [![Java CI](https://github.com/grails-plugins/elasticsearch-grails-plugin/actions/workflows/gradle.yml/badge.svg)](https://github.com/grails-plugins/elasticsearch-grails-plugin/actions/workflows/gradle.yml)
